...
@section('content')
    ...
    <div class="max-w-2xl">
        ...
        <div class="bg-white rounded-2xl border border-[#E4E1DA] p-8">
            ...
            <h2 class="font-display text-xl font-semibold mb-1">Add New Employee</h2>
            <p class="text-[#6B7280] text-sm mb-8">Fill in the details below to add a new employee record.</p>
            ...
            <form action="{{ route('employees.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Ahmad Fauzan"
                ...
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position') }}" placeholder="e.g. Staff IT"
